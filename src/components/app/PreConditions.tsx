...
const FailedPreCondition = ({
	...
	switch (failedPreCondition) {
		case PRE_CONDITION_COOKIES:
			return (
				<>
					<h2>Bitte aktivieren Sie Cookies, um fortzufahren</h2>
					<p>
						Bitte aktivieren Sie bei Ihrem Browser Cookies, um die
						Anmeldung zu ermöglichen.
					</p>
					<p>
						Nachdem Sie Cookies in Ihrem Browser aktiviert haben,
						klicken Sie einfach auf die Schaltfläche unten, um zur
					...
					<Button
						...
						item={{
							label: 'Zurück zur vorheringen Seite',
