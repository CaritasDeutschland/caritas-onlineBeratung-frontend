export const deInformal = {
	...
	twoFactorAuth: {
		...
		activate: {
			...
			step1: {
				copy: 'Installiere Dir auf Deinem Smartphone oder Tablet eine passende Authenticator-App. Alternativ kannst Du auch Deine E-Mail-Adresse für die Zwei-Faktor-Athentifizierung (2FA) verwenden.'
			},
			email: {
				step3: {
					copy: {
				...
				confirmOverlay: {
					...
					consultant: {
						...
						appSwitch: {
							...
							copy: 'Wechsel den zweiten Faktor von "E-Mail Adresse" zu "App". Dann kannst Du Deine E-Mail Adresse hier ändern.'
						},
						reset: {
							title: 'Rücksetzen der 2-Faktor-Authentifizierung (2FA)',
							copy: 'Klicke im nächsten Fenster auf „2FA zurücksetzen“. Du wirst anschließend automatisch abgemeldet. Melde dich danach noch einmal mit deiner bisherigen E-Mail-Adresse an. Beim nächsten Login richte die Zwei-Faktor-Authentifizierung erneut ein. Gib dabei deine neue E-Mail-Adresse an. Diese wird automatisch in deinem Profil übernommen.'
						}
					}
				}
			}
